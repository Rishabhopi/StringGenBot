...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@Ur_Rishu_143"))
        else:
            ...
            await client.join_chat("Ur_rishu_143")
    except KeyError:
        pass
    try:
